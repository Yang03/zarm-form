...
var FORM_ITEM = ['Input', 'Checkbox', 'FilePicker', 'Select', 'DateSelect', 'CheckboxGroup', 'Radio', 'RadioGroup'];
  ...
  function ZarmForm(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "changeValdiate", function (key, value) {
      var _this$props = _this.props,
          ...
          rules = _this$props$rules === void 0 ? [] : _this$props$rules; // values[key] = value
        ...
        if (elemetTypeName === 'Select' || elemetTypeName === 'DateSelect') {
          return (0, _react.cloneElement)(element, {
            ...
            onCancel: function onCancel(value) {
              return _this2.onCancel(element.props.name, values[element.props.name]);
            }
          });
        }
